...
#define ENUMERATE_CSS_STYLE_VALUE_TYPES                                                                                                        \
    ...
    __ENUMERATE_CSS_STYLE_VALUE_TYPE(OffsetPath, offset_path, OffsetPathStyleValue)                                                            \
    __ENUMERATE_CSS_STYLE_VALUE_TYPE(OffsetRotate, offset_rotate, OffsetRotateStyleValue)                                                      \
